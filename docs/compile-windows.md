...
-   `MSBuild traaittPlatform.sln /p:Configuration=Release /p:PlatformToolset=v142 /m` or `MSBuild src\cli.vcxproj /p:Configuration=Release /p:PlatformToolset=v141 /m`
...
-   `MSBuild traaittPlatform.sln /p:Configuration=Release /p:Platform=Win32 /p:PlatformToolset=v142 /m`
