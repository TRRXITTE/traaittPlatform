...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        /* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
           You can get this value by doing "print_block 2" in ETRXnetwork. It is used to know what timestamp
           to import from when the block height cannot be found in the node or the node is offline. */
        const uint64_t GENESIS_BLOCK_TIMESTAMP = 1574888787;
    ...
    const char CRYPTONOTE_NAME[] = "traaittPlatform";
    ...
    const char LATEST_VERSION_URL[] = "http://github.com/TRRXITTE/traaittPlatform/releases";
    ...
    const char *const SEED_NODES[] = {
	  "34.173.255.181:24411", //PRIMARY SET
      "34.134.15.101:24411" //
    };
} // namespace CryptoNote
